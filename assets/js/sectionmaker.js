	    ...
	    '<div class="col-12 col-md-6 col-lg-4 pt-5 pb-3">',
	        ...
	        '</div>',
        		'<div class="card-body"',
        			...
        			'<div class="row">',
        				'<div class="col-6"><a class="btn btn-outline-secondary" href="https://mattson543.github.io/' + name + '/">View Project</a></div>',
        				'<div class="col-6"><a class="btn btn-outline-secondary" href="https://github.com/mattson543/' + name + '"><i class="fab fa-github"></i> GitHub</a></div>',
	        		'</div>',
	        	'</div>',
	        '</div>',
	    '</div>'
